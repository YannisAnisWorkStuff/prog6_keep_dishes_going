...
import com.yiannisftiti.prog6.keepdishesgoing.owner.port.in.dish.MarkDishBackInStockUseCase;
...
@Service
public class MarkDishBackInStockUseCaseImpl implements MarkDishBackInStockUseCase {
    ...
    public MarkDishBackInStockUseCaseImpl(
    ...
    @Transactional
    @Override
    public void markBackInStock(DishId dishId, RestaurantId restaurantId)
        ...
        restaurant.markDishBackInStock(dish);
